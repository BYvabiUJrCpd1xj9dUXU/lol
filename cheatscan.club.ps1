...
Write-Host "Made by cheatscan.club`nVisit cheatscan.club for Questions or Bugs`n" -ForegroundColor Cyan
Write-Host @"
...
$lineWidth = 100
Write-Host "cheatscan.club Mod Analyzer V6.0".PadLeft(($lineWidth + 34) / 2) -ForegroundColor Cyan
...
$counter = 0
$tempDir = Join-Path $env:TEMP "cheatscanclubmodanalyzer"
try {
...
Write-Sep
Write-Host "Powered by cheatscan.club" -ForegroundColor DarkGray
